...
Public Partial Class viewsurgeries
	...
	Protected Sub appbtn_Click(sender As Object, e As EventArgs)
		...
		Dim qry As String = "select pid,patientname,age,department,doctor,convert(char(8),surgerydate,1) surgerydate from hospital_surgeryinfo where doctor='" + doctorddl.SelectedValue & "' "
		Dim da As New SqlDataAdapter(qry, cn)
		Dim ds As New DataSet()
		da.Fill(ds)
